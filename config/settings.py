...
DATA_COLLECTION_INTERVAL = 4.0  # seconds (Unified interval for ML synchronization)

KEYSTROKE_LOG_INTERVAL = DATA_COLLECTION_INTERVAL
WINDOW_TRACK_INTERVAL = DATA_COLLECTION_INTERVAL
WEBCAM_CAPTURE_INTERVAL = DATA_COLLECTION_INTERVAL
